...
@TeleOp(name="Starter Bot Old Code", group="Iterative Opmode")

public class StarterBotOldCode extends OpMode
{
    ...
    public void loop() {
        ...
        leftPower    = Range.clip(drive + turn, -0.75, 0.75) ;//0.55
        rightPower   = Range.clip(drive - turn, -0.75, 0.75) ;//0.55
